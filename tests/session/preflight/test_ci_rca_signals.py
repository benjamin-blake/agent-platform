...
class TestAbstentionSurfaceConfidenceMatrix:
    ...
    def test_section_title_and_decision_substring_retained(self, capsys):
    ...
    def test_overflow_label_matches_widened_wording(self, capsys):
