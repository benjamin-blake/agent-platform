...
| 6 | static | Confirm repo rename candidates enumerated | `grep -iE "agentic-platform\|agent-platform\|self-improving" docs/INTENT-aws-migration-platform-evolution.md` | At least three named candidates appear in the doc | Fewer than three candidates -- choice not deliberated |
