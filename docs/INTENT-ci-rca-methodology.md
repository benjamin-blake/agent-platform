...
evidence_bundle_ref:
  ...
  fields:
    ...
    s3_uri:
      type: str
      required: true
      pattern: '^s3://agent-platform-agent-logs/ci-rca-evidence/[0-9a-f]{64}\.json$'
    upload_status:
      type: enum
