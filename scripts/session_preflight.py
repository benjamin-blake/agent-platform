...
def main(roadmap_detail: str = "slim") -> int:
    ...
    ci_rca_telemetry = _compute_ci_rca_telemetry(recs_cache)
    ci_rca_back_validation = _derive_ci_rca_back_validation(recs_cache)
    print_ci_rca_telemetry(ci_rca_telemetry)
    print_ci_rca_back_validation(ci_rca_back_validation)
